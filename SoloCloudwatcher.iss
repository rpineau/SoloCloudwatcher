...
#define MyAppName "SoloCloudwatcher X2 Plugin"
...
AppId={{A570225E-BEB8-4681-BA0A-518FA9DC7EF1}
AppName={#MyAppName}
...
OutputBaseFilename=SoloCloudwatcher_X2_Installer
...
Source: "weatherstationlist SoloCloudwatcher.txt";                   DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion
Source: "weatherstationlist SoloCloudwatcher.txt";                   DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion; DestName: "weatherstationlist64 SoloCloudwatcher.txt"
; 32 bit
Source: "libSoloCloudwatcher\Win32\Release\libSoloCloudwatcher.dll";      DestDir: "{app}\Plugins\WeatherStationPlugIns"; Flags: ignoreversion
Source: "SoloCloudwatcher.ui";                                       DestDir: "{app}\Plugins\WeatherStationPlugIns"; Flags: ignoreversion

; 64 bit
Source: "libSoloCloudwatcher\x64\Release\libSoloCloudwatcher.dll";        DestDir: "{app}\Plugins64\WeatherStationPlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\WeatherStationPlugIns'))
Source: "SoloCloudwatcher.ui";                                       DestDir: "{app}\Plugins64\WeatherStationPlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\WeatherStationPlugIns'))
